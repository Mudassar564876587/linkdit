        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-28 sm:px-6 sm:pb-28 sm:pt-32 lg:px-8 lg:pb-36 lg:pt-40">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            <div className="relative z-10 text-center lg:text-left">
              ...
              <h1 className="text-[2rem] font-bold leading-[1.08] tracking-[-0.03em] text-foreground xs:text-[2.5rem] sm:text-[3.5rem] lg:text-[4rem] xl:text-[4.75rem] xl:leading-[1.02]">
                Find the Best{" "}
                <span className="bg-gradient-to-r from-blue-600 via-indigo-500 to-violet-600 bg-clip-text text-transparent animate-gradient [filter:drop-shadow(0_0_24px_rgba(99,102,241,0.3))]">
                  AI Tools
                </span>
                <br />
                for Every Task
            ...
            {/* Premium hero visual — CSS-only glowing AI orb with orbiting cards */}
            <div className="relative hidden lg:block" aria-hidden="true">
              <div className="relative mx-auto flex h-[520px] w-full max-w-lg items-center justify-center">
                {/* Central glowing orb */}
