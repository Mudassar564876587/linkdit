  ...
  return (
    <section className="border-t border-border bg-gradient-to-b from-secondary/30 to-white">
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-36">
        ...
        {articles.length === 0 ? (
          <div className="mt-16 mx-auto max-w-sm rounded-2xl border border-border/60 bg-white p-8 text-center shadow-premium">
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-3">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="rounded-2xl border border-border bg-white p-6">
              ...
              <div className="mt-3 h-6 w-full animate-pulse rounded bg-muted" />
