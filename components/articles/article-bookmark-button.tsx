...
import { addArticleBookmark, removeArticleBookmark } from "@/actions/dashboard/bookmarks"
...
export default function ArticleBookmarkButton({
  ...
  async function toggle() {
    ...
    setLoading(true)
    if (bookmarked) {
      await removeArticleBookmark(articleId)
    } else {
      await addArticleBookmark(articleId)
    }
